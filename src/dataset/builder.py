...
def build(poses:list[np.ndarray], segments:list, codebook:PoseCodebook, output_folder:Path, fps=60) -> Path:
    """
    ...
    tokens:np.ndarray = codebook.predict(poses)
