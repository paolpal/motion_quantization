import argparse
from motion_quantization.extraction.pose import extract_pose
from motion_quantization.extraction.transcription import fast_transcribe
from motion_quantization.extraction.audio import extract_audio
